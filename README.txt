...
of the interface. Also, A trigram model with add-k smoothing is implemented.
...
- (reuters_data.py): Reads the most popular trigrams from the Reuters Validation set and reads the reuters training data. Creates a new list containing sentences which has the popular trigrams.
...
*** [ Acknowledgements ]***
Python files adapted from a similar work by Sameer Singh
